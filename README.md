...
- **Oda durumları** — temiz / temizlikte / arızalı. Arızalı odada bitiş tarihi tutulur ve o aralıktaki rezervasyonlar engellenir.
...
- **Çıkış** — check-in yapılmış odalar çıkış yapar, oda otomatik "temiz" duruma alınır.
- **Takvim Görünümü** — odaların günlük doluluk ızgarası; ad yalnızca giriş gününde yazılır, diğer geceler X olur; ipucunda isim, giriş-çıkış, rezervasyon no, fiyat ve referans bilgisi.
